...
const SettingsPage = () => {
  ...
  }, /*#__PURE__*/React.createElement("h1", null, (0, _i18n.__)('HolyVonsheezy Theme Settings', 'holy-canvas'))))), /*#__PURE__*/React.createElement("div", {
...
const SettingsPanel = ({
  ...
  return /*#__PURE__*/React.createElement(_components.PanelBody, {
    title: (0, _i18n.__)('HolyVonsheezy Theme Settings', 'holy-canvas')
    ...
    label: (0, _i18n.__)('Unregister HolyVonsheezy style.css', 'holy-canvas'),
    help: (0, _i18n.__)("Disable HolyVonsheezy theme's style.css file which contains CSS reset rules for unified cross-browser view.", 'holy-canvas'),
    ...
    label: (0, _i18n.__)('Unregister HolyVonsheezy theme.css', 'holy-canvas'),
    help: (0, _i18n.__)("Disable HolyVonsheezy theme's theme.css file which contains CSS rules that style WordPress elements.", 'holy-canvas'),
