...
class ControlsHook extends $e.modules.hookUI.After {
  ...
  /**
   * Get CreatorMode Theme Controls
   *
   ...
   *   {
   *      vonsheezy_elementor_show_logo: '.site-header .site-header-logo',
   *      vonsheezy_elementor_show_menu: '.site-header .site-header-menu',
   *   }
   */
  getHolyVonsheezyThemeControls() {
    return {
      vonsheezy_header_logo_display: {
        selector: '.site-header .site-logo, .site-header .site-title',
        callback: ($element, args) => {
          this.toggleShowHideClass($element, args.settings.vonsheezy_header_logo_display);
        }
      },
      vonsheezy_header_menu_display: {
        selector: '.site-header .site-navigation, .site-header .site-navigation-toggle-holder',
        callback: ($element, args) => {
          this.toggleShowHideClass($element, args.settings.vonsheezy_header_menu_display);
        }
      },
      vonsheezy_header_tagline_display: {
        selector: '.site-header .site-description',
        callback: ($element, args) => {
          this.toggleShowHideClass($element, args.settings.vonsheezy_header_tagline_display);
        }
      },
      vonsheezy_header_logo_type: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'show-',
            inputOptions = args.container.controls.vonsheezy_header_logo_type.options,
            inputValue = args.settings.vonsheezy_header_logo_type;
      ...
      vonsheezy_header_layout: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'header-',
            inputOptions = args.container.controls.vonsheezy_header_layout.options,
            inputValue = args.settings.vonsheezy_header_layout;
          this.toggleLayoutClass($element, classPrefix, inputOptions, inputValue);
        }
      },
      vonsheezy_header_width: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'header-',
            inputOptions = args.container.controls.vonsheezy_header_width.options,
            inputValue = args.settings.vonsheezy_header_width;
          this.toggleLayoutClass($element, classPrefix, inputOptions, inputValue);
        }
      },
      vonsheezy_header_menu_layout: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'menu-layout-',
            inputOptions = args.container.controls.vonsheezy_header_menu_layout.options,
            inputValue = args.settings.vonsheezy_header_menu_layout;
      ...
      vonsheezy_header_menu_dropdown: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'menu-dropdown-',
            inputOptions = args.container.controls.vonsheezy_header_menu_dropdown.options,
            inputValue = args.settings.vonsheezy_header_menu_dropdown;
          this.toggleLayoutClass($element, classPrefix, inputOptions, inputValue);
        }
      },
      vonsheezy_footer_logo_display: {
        ...
        callback: ($element, args) => {
          this.toggleShowHideClass($element, args.settings.vonsheezy_footer_logo_display);
        }
      },
      vonsheezy_footer_tagline_display: {
        selector: '.site-footer .site-description',
        callback: ($element, args) => {
          this.toggleShowHideClass($element, args.settings.vonsheezy_footer_tagline_display);
        }
      },
      vonsheezy_footer_menu_display: {
        selector: '.site-footer .site-navigation',
        callback: ($element, args) => {
          this.toggleShowHideClass($element, args.settings.vonsheezy_footer_menu_display);
        }
      },
      vonsheezy_footer_copyright_display: {
        ...
        callback: ($element, args) => {
          const $footerContainer = $element.closest('#site-footer'),
            inputValue = args.settings.vonsheezy_footer_copyright_display;
      ...
      vonsheezy_footer_logo_type: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'show-',
            inputOptions = args.container.controls.vonsheezy_footer_logo_type.options,
            inputValue = args.settings.vonsheezy_footer_logo_type;
          this.toggleLayoutClass($element, classPrefix, inputOptions, inputValue);
        }
      },
      vonsheezy_footer_layout: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'footer-',
            inputOptions = args.container.controls.vonsheezy_footer_layout.options,
            inputValue = args.settings.vonsheezy_footer_layout;
          this.toggleLayoutClass($element, classPrefix, inputOptions, inputValue);
        }
      },
      vonsheezy_footer_width: {
        ...
        callback: ($element, args) => {
          const classPrefix = 'footer-',
            inputOptions = args.container.controls.vonsheezy_footer_width.options,
            inputValue = args.settings.vonsheezy_footer_width;
          this.toggleLayoutClass($element, classPrefix, inputOptions, inputValue);
        }
      },
      vonsheezy_footer_copyright_text: {
        selector: '.site-footer .copyright',
        callback: ($element, args) => {
          const inputValue = args.settings.vonsheezy_footer_copyright_text;
  ...
  getConditions(args) {
    ...
    return !!Object.keys(this.getHolyVonsheezyThemeControls()).includes(changedControls[0]);
  }
   ...
   */
  apply(args) {
    const allThemeControls = this.getHolyVonsheezyThemeControls(),
